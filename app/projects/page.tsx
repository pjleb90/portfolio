        ...
        <div className='flex flex-col gap-10 py-10 lg:flex-row lg: flex-wrap' style={{ display: 'flex', justifyContent: 'space-between' }}>
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800 ">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Link href="https://github.com/pjleb90/airbnb" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
          ...
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Link href="https://github.com/pjleb90/spotify" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
                    <AiFillGithub className="h-[3rem] w-[3rem]" style={{ display: 'inline' }}/>
                  </Link>
                </div>
            </div>
          ...
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Link href="https://github.com/pjleb90/e-comm-admin" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
                    <AiFillGithub className="h-[3rem] w-[3rem]" style={{ display: 'inline' }}/>
                  </Link>
                </div>
            </div>
          ...
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Link href="https://e-comm-store-chi.vercel.app/"
                    className="bg-gradient-to-r from-cyan-500 to-teal-400 text-gray-800
                      dark:text-grey-800 focus:ring-4 focus:outline-none rounded-lg px-4 py-2
                      text-center font-bold mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700"
                      style={{ display: 'inline' }}
                  ...
                  <Link href="https://github.com/pjleb90/e-comm-store" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
                    <AiFillGithub className="h-[3rem] w-[3rem]" style={{ display: 'inline' }}/>
                  </Link>
                </div>
            </div>
          ...
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Link href="https://github.com/pjleb90/SaaS-AI" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
                    <AiFillGithub className="h-[3rem] w-[3rem]" style={{ display: 'inline' }}/>
                  </Link>
                </div>
            </div>
          ...
          <div className="max-w-xl bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Link href="https://github.com/pjleb90/landscaping-temp" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-teal-500">
                    <AiFillGithub className="h-[3rem] w-[3rem]" style={{ display: 'inline' }}/>
                  </Link>
                </div>
            </div>
