const Footer = () => {
    return (
        <div className=' lg:flex gap-10 justify-center items-center border-t'>
            <div className='text-center shadow-lg shadow-teal-500 pt-2 pb-2 pl-10 pr-10 rounded-xl my-10'>
